        ...
        <div class="container">
            <div class="row gutters-10 position-relative">
                ...
                <div class="@if($num_todays_deal > 0) col-lg-7 @else col-lg-9 @endif">
                    ...
                    @endif
                    @if (count($featured_categories) > 0)
                        <div class="list-unstyled  aiz-carousel mb-0 row gutters-5"
                             data-items="6"
                             data-xs-items="4"
                             data-sm-items="3"
                             data-md-items="4"
    ...
    <section class="mb-4">
        <div class="container">
            <div class="px-2 py-4 px-md-4 py-md-3 bg-white shadow-sm rounded">
                ...
                <div class="row" id="ajax_all_product">
                </div>
                <div class="row justify-content-center">
                    <div class="col-auto">
                        <div class="spinner-border border-primary my-4" id="all_product_loader"></div>
                    </div>
                </div>
            </div>
        </div>
    ...
    <script>
        $(document).ready(function () {
            ...
            $(window).on('scroll', function () {
                var hT = $('#ajax_all_product').offset().top,
                    hH = $('#ajax_all_product').outerHeight(),
                    wH = $(window).height(),
                    wS = $(this).scrollTop();
            ...
            function loadMoreData() {
                $.ajax({
                    ...
                    if (!data) {
                        ...
                        $('#all_product_loader').removeClass('spinner-border').addClass('text-muted').show();
                        return;
                    }
